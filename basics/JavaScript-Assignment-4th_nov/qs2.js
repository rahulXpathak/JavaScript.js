...
HTML 
is used to structure the webpage, define headings (<h1>) and paragraphs (<p>), and create a clickable
text element with the ID "myText."

JavaScript
 is used to define a function (changeColor) that changes the color of the text with the ID "myText" to
